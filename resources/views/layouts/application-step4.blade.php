            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <hr>
                        <form action="/applicants/step4" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{{ $applicant->occupation or '' }}}" class="form-control" id="taskTitle"  name="occupation" >
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{{ $applicant->relationship or '' }}}" class="form-control" id="taskTitle"  name="relationship" >
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{{ $applicant->email or '' }}}" class="form-control" id="taskTitle"  name="email">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{{ $applicant->tel or '' }}}" class="form-control" id="taskTitle"  name="tel">
                                    </div>
